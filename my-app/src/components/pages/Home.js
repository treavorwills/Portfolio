        ...
        <div class="pt-10">
            <div class="flex flex-col-reverse md:flex-row text-2xl justify-center">
                ...
                <div class="sm:shrink-0">
                    <img class="h-48 rounded-t-xl md:rounded-tl-none md:rounded-r-xl w-full object-cover md:h-full md:w-48" src="https://www.placecage.com/200/200" alt="Modern building architecture"></img>
                </div>
            </div>
        </div>
    );
