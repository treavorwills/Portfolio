            ...
            <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
                ...
                <div className={"md:flex items-center" + (navBarOpen ? "flex ml-auto" : " hidden")}>
                    <ul className="flex flex-col md:flex-row list-none md:ml-auto">
                        <li className="nav-item flex justify-end"><Link className="px-3 py-2 hover:opacity-75" to="/about">About</Link></li>
                        <li className="nav-item flex justify-end"><Link className="px-3 py-2 flex items-center hover:opacity-75" to="/projects">Projects</Link></li>
                        <li className="nav-item flex justify-end"><Link className="px-3 py-2 flex items-center hover:opacity-75" to="/contact">Contact</Link></li>
                        <li className="nav-item flex justify-end"><Link className="px-3 py-2 flex items-center hover:opacity-75" to="/resume">Resume</Link></li>
                    </ul>
                </div>
            </div>
        </nav>
