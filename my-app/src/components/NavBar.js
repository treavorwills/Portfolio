        ...
        <nav class="relative flex flex-wrap items-center justify-between px-2 py-3 bg-emerald-200 mb-1">
            <div class="container px-4 mx-auto flex flex-wrap items-center justify-between">
                <div class="w-full relative flex justify-between md:w-auto md:static md:block md:justify-start">
                    <Link to="/Portfolio" class="font-bold leading-relaxed inline-block mr-4 py-2">
                ...
                <div class={"md:flex items-center" + (navBarOpen ? "flex ml-auto" : " hidden")}>
                    <ul class="flex flex-col md:flex-row list-none md:ml-auto">
                        <li class="nav-item flex justify-end"><Link class="px-3 py-2 hover:opacity-75" to="/Portfolio/about">About</Link></li>
                        <li class="nav-item flex justify-end"><Link class="px-3 py-2 flex items-center hover:opacity-75" to="/Portfolio/projects">Projects</Link></li>
                        <li class="nav-item flex justify-end"><Link class="px-3 py-2 flex items-center hover:opacity-75" to="/Portfolio/contact">Contact</Link></li>
                        <li class="nav-item flex justify-end"><Link class="px-3 py-2 flex items-center hover:opacity-75" to="/Portfolio/resume">Resume</Link></li>
                    </ul>
                </div>
            </div>
        </nav>
